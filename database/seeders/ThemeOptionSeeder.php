...
class ThemeOptionSeeder extends BaseSeeder
{
    ...
    public function run(): void
    {
        ...
        $this->createThemeOptions([
            ...
            'seo_description' => 'With experience, we make sure to get every project done very fast and in time with high quality using our Laravel CMS https://cms.fsofts.com',
            ...
            'site_description' => 'With experience, we make sure to get every project done very fast and in time with high quality using our Laravel CMS https://cms.fsofts.com',
            'phone' => '+(123) 345-6789',
