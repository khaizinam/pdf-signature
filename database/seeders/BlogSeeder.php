        ...
        foreach ($posts as $index => &$item) {
            $item['content'] =
                ...
                Html::tag(
                    'p',
                    Html::image(
                        AppMedia::getImageUrl('news/' . $faker->numberBetween(1, 5) . '.jpg', 'medium'),
                        'image',
                ...
                Html::tag(
                    'p',
                    Html::image(
                        AppMedia::getImageUrl('news/' . $faker->numberBetween(6, 10) . '.jpg', 'medium'),
                        'image',
                        ['style' => 'width: 100%', 'class' => 'image_resized']
                    )
                        ->toHtml(),
                ...
                Html::tag(
                    'p',
                    Html::image(
                        AppMedia::getImageUrl('news/' . $faker->numberBetween(11, 14) . '.jpg', 'medium'),
                        'image',
                        ['style' => 'width: 100%', 'class' => 'image_resized']
                    )
                        ->toHtml(),
