        ...
        try {
            ...
            foreach ($members as $member) :
                ...
                if (
                    ...
                    event(new MemberBirthdayEvent($member, $remaining_days));
                else:
                    $this->info("Member {$member->name} has been notify in $remaining_days days");
                    Log::channel($this->logger)->info("Member {$member->name} has been notify in $remaining_days days");
                endif;
            endforeach;
        } catch (Throwable $th) {
