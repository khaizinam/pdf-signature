...
use Dev\Location\Events\DownloadedCities;
use Dev\Location\Events\DownloadedCountry;
use Dev\Location\Events\DownloadedStates;
...
class Location
{
    ...
    {
        try {
            $url = 'https://api.github.com/repos/vswb/locations/git/trees/master';
    ...
    {
        $repository = 'https://cms.fsofts.comlocations';
