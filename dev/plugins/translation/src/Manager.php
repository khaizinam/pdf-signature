...
class Manager
{
    ...
    {
        $this->files->ensureDirectoryExists(lang_path('vendor/ui'));
    ...
    {
        $themePath = lang_path("vendor/ui/$theme");
    ...
    public function getThemeTranslationPath(string $locale, ?string $theme = ''): string
    {
        ...
        $localeFilePath = $defaultLocaleFilePath = lang_path("vendor/ui/$theme/$locale.json");
    ...
    public function ensureAllDirectoriesAreCreated(): void
    {
        ...
        $this->files->ensureDirectoryExists(lang_path('vendor/libs'));
