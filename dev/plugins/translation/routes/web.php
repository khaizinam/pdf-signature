...
use Dev\Translation\Http\Controllers\ExportOtherTranslationController;
use Dev\Translation\Http\Controllers\ExportThemeTranslationController;
use Dev\Translation\Http\Controllers\ImportOtherTranslationController;
use Dev\Translation\Http\Controllers\ImportThemeTranslationController;
use Illuminate\Support\Facades\Route;

Route::group(['namespace' => 'Dev\Translation\Http\Controllers'], function () {
