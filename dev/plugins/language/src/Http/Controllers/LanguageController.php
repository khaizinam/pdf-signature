...
namespace Dev\Language\Http\Controllers;
...
use Dev\Language\Forms\Settings\LanguageSettingForm;
use Dev\Language\Http\Requests\LanguageRequest;
        ...
        try {
            ...
            if (! File::isDirectory(lang_path($locale))) {
                ...
                if (! $importedLocale) {
                    ...
                    $this->createLocaleInPath(lang_path('vendor/libs'), $locale);
