@foreach($customFields as $customField)
    ...
    @endif
        ...
        @elseif($customField->type == \Dev\Contact\Enums\CustomFieldType::CHECKBOX)
            @continue(! $customField->options->filter(fn ($option) => ! empty($option->label)))
            <div class="col-md-12">
                <div class="form-group mb-3">
