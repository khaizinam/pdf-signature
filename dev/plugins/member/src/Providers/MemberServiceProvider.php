...
use Dev\Base\Supports\Language as BaseLanguage;
...
use Dev\Member\Forms\Fronts\Auth\LoginForm;
use Dev\Member\Forms\Fronts\Auth\RegisterForm;
use Dev\Member\Forms\Fronts\Auth\ResetPasswordForm;
use Dev\Member\Http\Middleware\RedirectIfMember;
use Dev\Member\Http\Middleware\RedirectIfNotMember;
use Dev\Member\Http\Requests\Fronts\Auth\ForgotPasswordRequest;
use Dev\Member\Http\Requests\Fronts\Auth\LoginRequest;
use Dev\Member\Http\Requests\Fronts\Auth\RegisterRequest;
...
use Dev\Member\Repositories\Eloquent\MemberActivityLogRepository;
use Dev\Member\Repositories\Eloquent\MemberRepository;
