...
use Dev\Table\Abstracts\Concerns\DeprecatedFunctions;
use Dev\Table\Abstracts\Concerns\HasActions;
use Dev\Table\Abstracts\Concerns\HasBulkActions;
use Dev\Table\Abstracts\Concerns\HasColumnVisibility;
use Dev\Table\Abstracts\Concerns\HasFilters;
use Dev\Table\Abstracts\Concerns\HasHeaderActions;
use Dev\Table\Columns\CheckboxColumn;
use Dev\Table\Columns\Column;
use Dev\Table\Columns\RowActionsColumn;
use Dev\Table\Contracts\FormattedColumn;
use Dev\Table\HeaderActions\HeaderAction;
use Dev\Table\Supports\Builder as CustomTableBuilder;
use Dev\Table\Supports\TableExportHandler;
use Closure;
...
abstract class TableAbstract extends DataTable implements ExtensibleContract
{
    ...
    /**
     * @param  \Dev\Table\Columns\Column[]  $columns
     */
