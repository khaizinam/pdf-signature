;(($, DataTable) => {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: (dt) => {
            ...
            ${dt.i18n(
                'buttons.excel',
                AppVars.languages.tables.excel ? AppVars.languages.tables.excel : 'Excel'
            )}`
        },
    ...
    DataTable.ext.buttons.export = {
        ...
        text: (dt) => {
            ...
            ${dt.i18n(
                'buttons.export',
                AppVars.languages.tables.export ? AppVars.languages.tables.export : 'Export'
            )}`
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: (dt) => {
            ...
            ${dt.i18n(
                'buttons.csv',
                AppVars.languages.tables.csv ? AppVars.languages.tables.csv : 'CSV'
            )}`
        },
    ...
    DataTable.ext.buttons.print = {
        ...
        text: (dt) => {
            return `<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                ${dt.i18n(
                    'buttons.print',
                    AppVars.languages.tables.print ? AppVars.languages.tables.print : 'Print'
                )}`
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: (dt) => {
            return `<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                ${dt.i18n(
                    'buttons.reset',
                    AppVars.languages.tables.reset ? AppVars.languages.tables.reset : 'Reset'
                )}`
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: (dt) => {
            return `
                ...
                ${dt.i18n(
                    'buttons.reload',
                    AppVars.languages.tables.reload ? AppVars.languages.tables.reload : 'Reload'
                )}`
        },
    ...
    class TableManagement {
        ...
        handleActionsRow() {
            ...
            $(document).on('click', '.delete-many-entry-trigger', (event) => {
                ...
                if (ids.length === 0) {
                    Apps.showError(
                        AppVars.languages.tables.please_select_record
                            ? AppVars.languages.tables.please_select_record
