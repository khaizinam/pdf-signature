...
use Dev\ACL\Http\Controllers\Auth\ForgotPasswordController;
use Dev\ACL\Http\Controllers\Auth\LoginController;
use Dev\ACL\Http\Controllers\Auth\ResetPasswordController;
use Dev\ACL\Http\Middleware\CheckUserUpdatePermission;
use Dev\Base\Facades\AdminHelper;
use Illuminate\Support\Facades\Route;

Route::group(['namespace' => 'Dev\ACL\Http\Controllers'], function () {
