...
namespace Dev\ACL\Http\Controllers;

use Dev\ACL\Forms\PasswordForm;
use Dev\ACL\Forms\PreferenceForm;
use Dev\ACL\Forms\ProfileForm;
use Dev\ACL\Forms\UserForm;
use Dev\ACL\Http\Requests\AvatarRequest;
use Dev\ACL\Http\Requests\CreateUserRequest;
use Dev\ACL\Http\Requests\PreferencePatchRequest;
...
use Dev\ACL\Services\ChangePasswordService;
use Dev\ACL\Services\CreateUserService;
use Dev\ACL\Tables\UserTable;
...
class UserController extends BaseSystemController
{
    ...
    public function postAvatar(User $user, AvatarRequest $request)
    {
        ...
        try {
            $result = AppMedia::uploadFromBlob($request->file('avatar_file'), folderSlug: 'users');
