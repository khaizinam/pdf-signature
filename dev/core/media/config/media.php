...
return [
    ...
    'allowed_mime_types' => env(
        'APP_MEDIA_ALLOWED_MIME_TYPES',
        'jpg,jpeg,png,gif,txt,docx,zip,mp3,bmp,csv,xls,xlsx,ppt,pptx,pdf,mp4,m4v,doc,mpga,wav,webp,webm,mov,jfif'
    ),
    'mime_types' => [
        'image' => [
            'image/png',
    ...
    'default_image' => env('APP_MEDIA_DEFAULT_IMAGE', '/vendor/core/core/base/images/placeholder.png'),
    'sidebar_display' => env('APP_MEDIA_SIDEBAR_DISPLAY', 'horizontal'), // Use "vertical" or "horizontal"
    'watermark' => [
        'enabled' => env('APP_MEDIA_WATERMARK_ENABLED', 0),
        'source' => env('APP_MEDIA_WATERMARK_SOURCE'),
        'size' => env('APP_MEDIA_WATERMARK_SIZE', 10),
        'opacity' => env('APP_MEDIA_WATERMARK_OPACITY', 70),
        'position' => env('APP_MEDIA_WATERMARK_POSITION', 'bottom-right'),
        'x' => env('APP_MEDIA_WATERMARK_X', 10),
        'y' => env('APP_MEDIA_WATERMARK_Y', 10),
    ],

    'chunk' => [
        'enabled' => env('APP_MEDIA_UPLOAD_CHUNK', false),
    ...
    'preview' => [
        'document' => [
            'enabled' => env('APP_MEDIA_DOCUMENT_PREVIEW_ENABLED', true),
            'providers' => [
                'google' => 'https://docs.google.com/gview?embedded=true&url={url}',
                'microsoft' => 'https://view.officeapps.live.com/op/view.aspx?src={url}',
            ],
            'default' => env('APP_MEDIA_DOCUMENT_PREVIEW_PROVIDER', 'microsoft'),
            'type' => env('APP_MEDIA_DOCUMENT_PREVIEW_TYPE', 'iframe'),          // use iframe or popup
            'mime_types' => [
                'application/pdf',
                'application/vnd.ms-excel',
                'application/excel',
    ...
    'default_upload_folder' => env('APP_MEDIA_DEFAULT_UPLOAD_FOLDER'),
    'default_upload_url' => env('APP_MEDIA_DEFAULT_UPLOAD_URL'),
