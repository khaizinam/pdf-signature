...
namespace Dev\Media\Facades;

use Dev\Media\AppMedia as BaseAppMedia;
 ...
 * @method static bool deleteFile(\Dev\Media\Models\MediaFile $file)
 * @method static bool deleteThumbnails(\Dev\Media\Models\MediaFile $file)
 ...
 * @method static \Dev\Media\AppMedia addSize(string $name, string|int $width, string|int $height = 'auto')
 * @method static \Dev\Media\AppMedia removeSize(string $name)
 ...
 * @method static bool generateThumbnails(\Dev\Media\Models\MediaFile $file, \Illuminate\Http\UploadedFile|null $fileUpload = null)
 ...
 * @method static void renameFile(\Dev\Media\Models\MediaFile $file, string $newName, bool $renameOnDisk = true)
 * @method static void renameFolder(\Dev\Media\Models\MediaFolder $folder, string $newName, bool $renameOnDisk = true)
 ...
 *
 * @see \Dev\Media\AppMedia
 */
class AppMedia extends Facade
{
    protected static function getFacadeAccessor(): string
    {
        return BaseAppMedia::class;
    }
}
