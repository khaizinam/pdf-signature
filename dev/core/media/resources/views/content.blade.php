<div class="app-media-container">
    <x-core::card class="app-media-wrapper">
        <input
            type="checkbox"
        ...
        <x-core::offcanvas
            id="app-media-aside"
            @class(['d-md-none' => AppMedia::getConfig('sidebar_display') !== 'vertical'])
            ...
            <x-core::offcanvas.body class="p-0">
                <x-core::list-group :flush="true">
                    ...
                    <x-core::list-group.item
                        :action="true"
                        class="js-app-media-change-filter"
                        data-type="filter"
                    ...
                    @if (array_key_exists('image', AppMedia::getConfig('mime_types', [])))
                        <x-core::list-group.item
                            :action="true"
                            class="js-app-media-change-filter"
                            data-type="filter"
                    ...
                    @if (array_key_exists('video', AppMedia::getConfig('mime_types', [])))
                        <x-core::list-group.item
                            :action="true"
                            class="js-app-media-change-filter"
                            data-type="filter"
                ...
                <x-core::list-group :flush="true">
                    ...
                    @if (AppMedia::hasAnyPermission(['folders.destroy', 'files.destroy']))
                        <x-core::list-group.item
                            :action="true"
                            class="js-app-media-change-filter"
                            data-type="view_in"
        ...
        <div class="app-media-main-wrapper">
            <x-core::card.header class="flex-column app-media-header p-0">
                <div class="w-100 p-2 app-media-top-header flex-wrap gap-3 d-flex justify-content-between align-items-start border-bottom bg-body">
                    <div class="d-flex gap-2 justify-content-between w-100 w-md-auto app-media-actions">
                        <x:core::button
                            class="d-flex d-md-none"
                            icon="ti ti-menu-2"
                            :icon-only="true"
                            data-bs-toggle="offcanvas"
                            href="#app-media-aside"
                        />

                        <div class="btn-list">
                            @if (AppMedia::hasPermission('files.create'))
                                <x-core::dropdown
                            ...
                            @if (AppMedia::hasPermission('folders.create'))
                                <x-core::button
                                    type="button"
                                    color="primary"
                            ...
                            @if (AppMedia::getConfig('sidebar_display') !== 'vertical')
                                <x-core::dropdown wrapper-class="d-none d-md-block">
                                    <x-slot:trigger>
                                        <x-core::button
                                            ...
                                            color="primary"
                                            icon="ti ti-filter"
                                            class="dropdown-toggle js-app-media-change-filter-group js-filter-by-type"
                                            data-bs-toggle="dropdown"
                                            :tooltip="trans('core/media::media.filter')"
                                        >
                                            <span class="js-app-media-filter-current"></span>
                                        </x-core::button>
                                    </x-slot:trigger>
                                ...
                                <x-core::dropdown wrapper-class="d-none d-md-block">
                                    <x-slot:trigger>
                                        <x-core::button
                                            ...
                                            color="primary"
                                            icon="ti ti-eye"
                                            class="dropdown-toggle js-app-media-change-filter-group js-filter-by-view-in"
                                            data-bs-toggle="dropdown"
                ...
                <div class="w-100 d-flex flex-wrap gap-3 p-2">
                    <div class="d-flex w-100 w-md-auto align-items-center app-media-breadcrumb">
                        <ul class="breadcrumb"></ul>
                    </div>
                    <div class="d-flex justify-content-between justify-content-md-end align-items-center app-media-tools w-100 w-md-auto">
                        <div
                            class="btn-list"
                            role="group"
                        >
                            ...
                            <x-core::dropdown
                                ...
                                wrapper-class="app-dropdown-actions"
                                :disabled="true"
                            />
                        </div>
                        <div
                            class="btn-group js-app-media-change-view-type ms-2"
                            role="group"
                        >
                            <x-core::button
                                type="button"
            ...
            <main class="app-media-main">
                <div class="app-media-items"></div>
                <div class="app-media-details" style="display: none">
                    <div class="app-media-thumbnail">
                        <x-core::icon name="ti ti-photo" />
                    </div>
                    <div class="app-media-description">
                        <div class="app-media-name">
                            <p>{{ trans('core/media::media.nothing_is_selected') }}</p>
                        </div>
                    </div>
                </div>
            </main>
            <footer class="d-none app-media-footer">
                <x-core::button
                    type="button"
                    color="primary"
        ...
        <div class="app-upload-progress hide-the-pane position-fixed bottom-0 end-0 ">
            <x-core::card>
                ...
                >
                    <x-core::table>
                        <x-core::table.body class="app-upload-progress-table"></x-core::table.body>
                    </x-core::table>
                </div>
            </x-core::card>
        </div>
...
<x-core::modal
    ...
    :has-form="true"
    :form-attrs="['class' => 'app-form form-add-folder']"
>
    ...
    >
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="app-form form-download-url">
...
<x-core::modal
    ...
    id="modal_crop_image"
    size="lg"
    :form-attrs="['class' => 'app-form form-crop']"
    :has-form="true"
>
    <div>
        <input
...
>
    ...
    <x-core::form.color-selector
        ...
        name="color"
        :choices="AppMedia::getFolderColors()"
    />
...
<button class="d-none js-app-clipboard-temp"></button>

<x-core::custom-template id="app_media_loading">
    <x-core::loading />
</x-core::custom-template>

<x-core::custom-template id="app_action_item">
    <x-core::dropdown.item
...
<x-core::custom-template id="app_media_items_list">
    <div class="app-media-list">
        <ul>
            ...
            <li class="app-media-list-title up-one-level js-up-one-level" title="{{ trans('core/media::media.up_level') }}">
                <div class="custom-checkbox"></div>
                <div class="app-media-file-name">
                    <x-core::icon name="ti ti-corner-up-left" />
                    <span>...</span>
                </div>
                <div class="app-media-file-size"></div>
                <div class="app-media-created-at"></div>
            </li>
        </ul>
    </div>
</x-core::custom-template>

<x-core::custom-template id="app_media_items_tiles" class="hidden">
    <div class="app-media-grid">
        <ul>
            <li class="no-items">
                __noItemIcon__
            ...
            <li class="app-media-list-title up-one-level js-up-one-level">
                <div class="app-media-item" data-context="__type__" title="{{ trans('core/media::media.up_level') }}">
                    <div class="app-media-thumbnail">
...
<x-core::custom-template id="app_media_items_list_element">
    <li class="app-media-list-title js-media-list-title js-context-menu" data-context="__type__" title="__name__" data-id="__id__">
        ...
        <div class="app-media-file-size">__size__</div>
        <div class="app-media-created-at">__date__</div>
    </li>
</x-core::custom-template>

<x-core::custom-template id="app_media_items_tiles_element">
    <li class="app-media-list-title js-media-list-title js-context-menu" data-context="__type__" data-id="__id__">
        <input type="checkbox" class="hidden">
        <div class="app-media-item" title="__name__">
...
<x-core::custom-template id="app_media_upload_progress_item">
...
<x-core::custom-template id="app_media_breadcrumb_item">
    <li>
...
<x-core::custom-template id="app_media_rename_item">
    <div class="mb-3">
        <div class="input-group">
...
<x-core::custom-template id="app_media_alt_text_item">
    <div class="mb-3">
        <div class="input-group">
...
<x-core::custom-template id="app_media_crop_image">
