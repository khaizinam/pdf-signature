...
let defaultConfig = {
    app_key: APP_MEDIA_CONFIG.random_hash ? APP_MEDIA_CONFIG.random_hash : '21d06709fe1d3abdf0e35ddda89c4b282',
    request_params: {
        view_type: 'tiles',
        filter: 'everything',
        view_in: 'all_media',
    ...
    actions_list: {
        ...
        file: [
            ...
            },
            {
                ...
                order: 4,
                class: 'app-action-copy-indirect-link',
            },
            {
