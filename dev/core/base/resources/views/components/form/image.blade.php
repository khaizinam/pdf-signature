@props([
    'name',
    'value',
    'defaultImage' => AppMedia::getDefaultImage(),
        ...
        <div class="preview-image-inner">
            ...
            >
                <x-core::image
                    ...
                    data-default="{{ $defaultImage = $defaultImage ?: AppMedia::getDefaultImage() }}"
                    src="{{ AppMedia::getImageUrl($value, $allowThumb ? 'thumb' : null, false, $defaultImage) }}"
