@php
    use Dev\Base\Enums\SystemUpdaterStepEnum;
    ...
    <div style="max-width: 900px;" class="m-auto">
        ...
        >
            <ul class="mt-3 mb-0 ps-2">
                ...
                <li>It will override all files in <strong>dev/core</strong>, <strong>dev/libs</strong>,
                    all
                    plugins developed by us in <strong>dev/plugins</strong> and theme developed by us in
