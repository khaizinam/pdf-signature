...
namespace Dev\Base\Commands;

use Dev\Base\Events\UpdatedEvent;
use Dev\Base\Events\UpdatingEvent;
...
class UpdateCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        array_map(fn (string $line) => note($line), [
            ...
            'It will override all files in <fg=yellow>./dev/core</>, <fg=yellow>./dev/libs</>, all plugins developed by us in <fg=yellow>./dev/plugins</> and theme developed by us in <fg=yellow>./dev/ui</>.',
        ]);
