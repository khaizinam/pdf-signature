...
use Dev\Base\Events\LicenseActivated;
use Dev\Base\Events\LicenseActivating;
use Dev\Base\Events\LicenseDeactivated;
use Dev\Base\Events\LicenseDeactivating;
use Dev\Base\Events\LicenseInvalid;
use Dev\Base\Events\LicenseRevoked;
use Dev\Base\Events\LicenseRevoking;
use Dev\Base\Events\LicenseUnverified;
use Dev\Base\Events\LicenseVerified;
use Dev\Base\Events\LicenseVerifying;
use Dev\Base\Events\SystemUpdateAvailable;
use Dev\Base\Events\SystemUpdateCachesCleared;
use Dev\Base\Events\SystemUpdateCachesClearing;
use Dev\Base\Events\SystemUpdateChecked;
use Dev\Base\Events\SystemUpdateChecking;
use Dev\Base\Events\SystemUpdateDBMigrated;
use Dev\Base\Events\SystemUpdateDBMigrating;
use Dev\Base\Events\SystemUpdateDownloaded;
use Dev\Base\Events\SystemUpdateDownloading;
use Dev\Base\Events\SystemUpdateExtractedFiles;
use Dev\Base\Events\SystemUpdatePublished;
use Dev\Base\Events\SystemUpdatePublishing;
use Dev\Base\Events\SystemUpdateUnavailable;
use Dev\Base\Exceptions\CouldNotConnectToLicenseServerException;
use Dev\Base\Exceptions\LicenseInvalidException;
use Dev\Base\Exceptions\LicenseIsAlreadyActivatedException;
use Dev\Base\Exceptions\MissingCURLExtensionException;
use Dev\Base\Exceptions\MissingZipExtensionException;
use Dev\Base\Exceptions\RequiresLicenseActivatedException;
...
final class Core
{
    ...
    private string $licenseUrl = 'https://license.cms.fsofts.com';
    ...
    /**
     * @throws \Dev\Base\Exceptions\LicenseInvalidException
     * @throws \Dev\Base\Exceptions\LicenseIsAlreadyActivatedException
     */
    ...
    private function validateUpdateFile(string $filePath): void
    {
        ...
        if ($zip->open($filePath)) {
             ...
             * }|null $content
             */
            $content = json_decode($zip->getFromName('dev/core/core.json'), true);
