...
use Dev\Installer\Events\EnvironmentSaved;
use Dev\Installer\Http\Requests\SaveEnvironmentRequest;
use Dev\Installer\Services\ImportDatabaseService;
use Dev\Installer\Supports\EnvironmentManager;
...
class EnvironmentController extends BaseController
{
    public function index(Request $request): View|RedirectResponse
    {
        ...
        return view('libs/installer::environment');
    }
