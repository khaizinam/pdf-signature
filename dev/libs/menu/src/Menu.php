...
use Dev\Base\Forms\FieldOptions\InputFieldOption;
...
use Dev\Support\Http\Requests\Request as BaseRequest;
...
class Menu
{
    ...
    public function __construct(CacheManager $cache, protected Repository $config)
    {
        ...
        $this->addMenuLocation('main-menu', trans('libs/menu::menu.main_navigation'));
    }
    ...
    public function addMenuLocation(string $location, string $description): self
    {
        ...
        $this->config->set('libs.menu.general.locations', $locations);
    ...
    {
        return $this->config->get('libs.menu.general.locations', []);
    }
    ...
    public function generateMenu(array $args = []): ?string
    {
        ...
        return view('libs/menu::partials.default', $data)->render();
    }
    ...
    public function registerMenuOptions(string $model, string $name): void
    {
        ...
        echo view('libs/menu::menu-options', compact('options', 'name'));
    }
    ...
    public function generateSelect(array $args = []): ?string
    {
        ...
        return view('libs/menu::partials.select', compact('items', 'model', 'options'))->render();
    }
        ...
        MenuNodeForm::extend(function (MenuNodeForm $form) {
            ...
            $form->add(
                ...
                TextFieldOption::make()
                    ->label(trans('libs/menu::menu.badge_text'))
                ...
                ->add(
                    ...
                    InputFieldOption::make()
                        ...
                        ->label(trans('libs/menu::menu.badge_color'))
                        ->toArray()
                );
