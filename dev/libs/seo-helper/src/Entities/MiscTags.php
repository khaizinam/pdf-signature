...
use Dev\SeoHelper\Contracts\Entities\MetaCollectionContract;
use Dev\SeoHelper\Contracts\Entities\MiscTagsContract;
use Dev\SeoHelper\Contracts\Entities\WebmastersContract;
...
class MiscTags implements MiscTagsContract
{
    ...
    public function __construct()
    {
        ...
        $this->addCanonical();
        $this->addMany(config('libs.seo-helper.general.misc.default', []));
    }
