...
use Dev\SeoHelper\Contracts\Entities\TitleContract;
...
class Title implements TitleContract
{
    ...
    protected function init()
    {
        ...
        $this->setSeparator(config('libs.seo-helper.general.title.separator', '-'));
        $this->switchPosition(config('libs.seo-helper.general.title.first', true));
        $this->setMax(config('libs.seo-helper.general.title.max', 55));
    }
