...
class ShortcodeField
{
    ...
    public function ids(string $field, array $attributes = [], array $options = []): string
    {
        ...
        return view('libs/shortcode::fields.select', compact(
            'field',
            'value',
            'options',
            'multiple'
    ...
    {
        return view('libs/shortcode::fields.lazy-loading', compact('attributes'))->render();
    }
}
