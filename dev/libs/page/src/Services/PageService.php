...
class PageService
{
    public function handleFrontRoutes(Slug|array|null $slug): Slug|array
    {
        ...
        if ($page->image) {
            SeoHelper::openGraph()->setImage(AppMedia::getImageUrl($page->image));
        }
        ...
        if (function_exists('admin_bar')) {
            admin_bar()
                ->registerLink(
                    trans('libs/page::pages.edit_this_page'),
        ...
        return [
            'view' => 'page',
            'default_view' => 'libs/page::themes.page',
            'data' => compact('page'),
            'slug' => $page->slug,
        ];
    }
