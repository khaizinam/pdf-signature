@php
    /** @var \Dev\DataSynchronize\Importer\Importer $importer */
...
<x-core::form
    ...
    :data-uploading-message="trans('libs/data-synchronize::data-synchronize.import.uploading_message')"
    :data-validate-failed-message="trans('libs/data-synchronize::data-synchronize.import.validating_failed_message')"
...
>
    <x-core::card>
            ...
            @if($importer->getExportUrl())
                ...
                >
                    {!! BaseHelper::clean(trans(
                        'libs/data-synchronize::data-synchronize.import.form.quick_export_message',
                        [
                            'label' => $importer->getLabel(),
                            'export_csv_link' => Html::tag('button', trans('libs/data-synchronize::data-synchronize.import.form.quick_export_button', ['format' => 'CSV']), [
                                'class' => 'data-synchronize-quick-export-button',
                                'data-bb-toggle' => 'quick-export',
                                'data-value' => 'csv',
                            ]),
                            'export_excel_link' => Html::tag('button', trans('libs/data-synchronize::data-synchronize.import.form.quick_export_button', ['format' => 'Excel']), [
                                'class' => 'data-synchronize-quick-export-button',
                                'data-bb-toggle' => 'quick-export',
                                'data-value' => 'xlsx',
                            ]),
            ...
            <div class="mb-3">
                <div class="dropzone">
                    <div class="dz-message">
                        {{ trans('libs/data-synchronize::data-synchronize.import.form.dropzone_message') }}
                    </div>
                </div>

                <x-core::form.helper-text class="mt-1">
                    {{ trans('libs/data-synchronize::data-synchronize.import.form.allowed_extensions', ['extensions' => Arr::join($importer->getFileExtensions(), ', ')]) }}
                </x-core::form.helper-text>
            </div>

            <div class="mb-3">
                <x-core::form.label for="chunk-size">{{ trans('libs/data-synchronize::data-synchronize.import.form.chunk_size') }}</x-core::form.label>
                <x-core::form.text-input type="number" class="form-control" id="chunk-size" name="chunk_size" value="{{ $importer->chunkSize() }}" />
                <x-core::form.helper-text>
                    {{ trans('libs/data-synchronize::data-synchronize.import.form.chunk_size_helper') }}
                </x-core::form.helper-text>
            </div>
        ...
        <x-core::card.footer>
            <x-core::button type="submit" color="primary" :disabled="true">
                {{ trans('libs/data-synchronize::data-synchronize.import.form.import_button') }}
            </x-core::button>
        </x-core::card.footer>
    </x-core::card>
    ...
    <x-core::card class="mt-3 bg-warning-lt" data-bb-toggle="import-failures" style="display: none">
        <x-core::card.header>
            <x-core::card.title>
                {{ trans('libs/data-synchronize::data-synchronize.import.failures.title') }}
            </x-core::card.title>
        </x-core::card.header>
        <x-core::table>
            <x-core::table.header>
                ...
                <x-core::table.header.cell>
                    {{ trans('libs/data-synchronize::data-synchronize.import.failures.attribute') }}
                </x-core::table.header.cell>
                <x-core::table.header.cell>
                    {{ trans('libs/data-synchronize::data-synchronize.import.failures.errors') }}
                </x-core::table.header.cell>
            </x-core::table.header>
...
@if($importer->getExportUrl())
    <x-core::form
        ...
        :data-success-message="trans('libs/data-synchronize::data-synchronize.export.success_message')"
        :data-error-message="trans('libs/data-synchronize::data-synchronize.export.error_message')"
    />
@endif

@if ($importer->getExamples())
    @include('libs/data-synchronize::partials.example')
@endif

@includeWhen($importer->showRulesCheatSheet(), 'libs/data-synchronize::partials.rules')
