...
namespace Dev\DataSynchronize\Exporter;

use Dev\Base\Facades\Assets;
use Dev\Base\Facades\BaseHelper;
use Dev\DataSynchronize\Concerns\Exporter\HasEmptyState;
use Dev\DataSynchronize\Enums\ExportColumnType;
use Carbon\Carbon;
...
abstract class Exporter implements FromCollection, ShouldAutoSize, WithColumnFormatting, WithEvents, WithHeadings, WithMapping
{
    ...
    /**
     * @return \Dev\DataSynchronize\Exporter\ExportColumn[]
     */
    ...
    {
        return trans(
            'libs/data-synchronize::data-synchronize.export.heading',
            ['label' => $this->getLabel()]
        );
    }
    ...
    /**
     * @return \Dev\DataSynchronize\Exporter\ExportCounter[]
     */
    ...
    {
        Assets::addScriptsDirectly('vendor/core/libs/data-synchronize/js/data-synchronize.js');

        return view('libs/data-synchronize::export', [
            'exporter' => $this,
        ]);
    }
