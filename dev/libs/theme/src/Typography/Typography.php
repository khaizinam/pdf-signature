...
namespace Dev\Theme\Typography;
...
use Dev\Theme\ThemeOption\Fields\GoogleFontsField;
use Dev\Theme\ThemeOption\Fields\NumberField;
        ...
        Event::listen(RenderingThemeOptionSettings::class, function () {
            ...
            ThemeOption::setSection(
                ThemeOptionSection::make('opt-text-subsection-typography')
                    ->title(trans('libs/theme::theme.typography'))
