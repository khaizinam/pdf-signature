...
use Dev\Theme\Forms\Fields\ThemeIconField;
use Dev\Theme\Http\Requests\UpdateOptionsRequest;
use Dev\Theme\ThemeOption\Fields\ColorField;
use Dev\Theme\ThemeOption\Fields\IconField;
use Dev\Theme\ThemeOption\Fields\MediaImageField;
use Dev\Theme\ThemeOption\Fields\NumberField as NumberFieldOption;
use Dev\Theme\ThemeOption\Fields\RepeaterField;
use Dev\Theme\ThemeOption\Fields\SelectField;
...
class ThemeSupport
{
    ...
    {
        $viewPath = $viewPath ?: 'libs/theme::shortcodes';
        ...
        shortcode()
            ...
            ->setPreviewImage('youtube-video', asset('vendor/core/libs/theme/images/ui-blocks/youtube-video.jpg'))
    ...
    public static function registerGoogleMapsShortcode(?string $viewPath = null): void
    {
        ...
        shortcode()
            ...
            ->setPreviewImage('google-map', asset('vendor/core/libs/theme/images/ui-blocks/google-map.jpg'))
    ...
    public static function registerPreloader(): void
    {
        add_filter(THEME_FRONT_HEADER, function (?string $html): string {
            ...
            if (theme_option('preloader_version', 'v1') === 'v1') {
                $preloader = view('libs/theme::fronts.preloader')->render();
            }
    ...
    public static function registerToastNotification(): void
    {
        add_filter(THEME_FRONT_FOOTER, function (?string $html): string {
            ...
            $toastNotification = view('libs/theme::fronts.toast-notification')->render();
    ...
    public static function registerThemeIconFields(array $icons, array $css = [], array $js = []): void
    {
        app()->booted(function () use ($icons) {
            app('form')->component(
                'themeIcon',
                $icons ? 'libs/theme::forms.fields.icons-field' : 'core/base::forms.partials.core-icon',
                [
                    'name',
                    'value' => null,
                    'attributes' => [],
    ...
    public static function registerFacebookIntegration(): void
    {
        ...
        add_filter(THEME_FRONT_FOOTER, function (?string $html): string {
            ...
            if (
                ...
                return $html . view('libs/theme::partials.facebook-integration')->render();
            }
        ...
        add_filter(BASE_FILTER_PUBLIC_COMMENT_AREA, function ($html) {
            if (
                ...
                return $html . view('libs/theme::partials.facebook-comments')->render();
            }
    ...
    public static function registerLazyLoadImages(): void
    {
        ...
        add_filter('core_media_image', function (
            ...
            return Html::image(AppMedia::getImageUrl($placeholderPath), $alt, $attributes, $secure);
        }, 120, 4);

        Theme::asset()
            ->container('footer')
            ->add('lazyload', asset('vendor/core/libs/theme/plugins/lazyload.min.js'));
    ...
    public static function getSocialSharingButtons(string $url, string $title, ?string $thumbnail = null): array
    {
        ...
        foreach ($socialSharing as $item) {
            ...
            $items[$social] = [
                ...
                'icon' => $image ? Html::image(AppMedia::getImageUrl($image), $name, attributes: ['loading' => false]) : BaseHelper::renderIcon($icon),
                'url' => match ($social) {
    ...
    public static function renderSocialSharingButtons(?string $url = null, ?string $title = null, ?string $thumbnail = null): string
    {
        ...
        return view('libs/theme::fronts.social-sharing', compact('socials', 'url'));
    }
    ...
    public static function supportedDateFormats(): array
    {
        ...
        if ($extraDateFormat = config('libs.theme.extra_date_format')) {
